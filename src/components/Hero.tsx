...
const Hero = () => {
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-secondary/5 to-background overflow-hidden">
      ...
      <div className="absolute top-32 left-20 w-40 h-40 bg-gradient-to-br from-purple-500/15 to-pink-500/10 rounded-full blur-3xl floating-animation premium-glow" style={{ animationDelay: '0s' }} />
      <div className="absolute bottom-40 right-24 w-32 h-32 bg-gradient-to-br from-blue-500/12 to-cyan-500/10 rounded-full blur-2xl floating-animation premium-glow" style={{ animationDelay: '2s' }} />
      <div className="absolute top-1/2 left-20 w-24 h-24 bg-gradient-to-br from-emerald-500/10 to-teal-500/8 rounded-full blur-xl floating-animation premium-glow" style={{ animationDelay: '4s' }} />
      <div className="absolute top-20 right-1/3 w-20 h-20 bg-gradient-to-br from-orange-500/8 to-yellow-500/8 rounded-full blur-lg floating-animation premium-glow" style={{ animationDelay: '1s' }} />
        ...
        <div className="max-w-6xl mx-auto text-center space-y-12">
          ...
          <div className="space-y-8">
            <h1 className="text-5xl md:text-7xl lg:text-8xl xl:text-9xl font-black leading-[0.85] tracking-tight text-shadow-lg">
              ...
              <span className="block bg-gradient-to-r from-purple-600 via-pink-500 to-blue-600 bg-clip-text text-transparent premium-text-glow">Digital Marketing Agency</span>
          ...
          <div className="space-y-6">
            <p className="text-xl md:text-2xl lg:text-3xl text-muted-foreground max-w-4xl mx-auto leading-relaxed font-medium">
              <span className="text-purple-700 font-bold">Extin Media</span> is Hyderabad's{" "}
          ...
          <div className="flex flex-col sm:flex-row gap-8 justify-center items-center pt-8">
            ...
            <Button 
              size="lg" 
              variant="outline" 
              className="group px-12 py-8 text-xl font-bold min-w-80 border-3 border-purple-600 text-purple-700 hover:bg-gradient-to-r hover:from-purple-600 hover:to-pink-600 hover:text-white premium-shadow hover:premium-shadow-hover transition-all duration-700 transform hover:scale-105 bg-background/90 backdrop-blur-sm rounded-2xl"
